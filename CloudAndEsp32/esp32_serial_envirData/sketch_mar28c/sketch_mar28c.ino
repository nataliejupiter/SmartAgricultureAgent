...
/* 云服务器接口 */
#define SERVER_URL  "http://8.152.218.172:8000/api/env-data" // 服务器运行相应后端代码/root/smart_agri/server/sensorDataPost
// 建议换成你自己设的长随机字符串
...
void mqttIntervalPost()
{
    ...
    snprintf(param, sizeof(param),
             "{\"CurrentTemperature\":%d,\"RelativeHumidity\":%d,\"SoilMoisture\":%d,\"LightLux\":%d,\"CO2Value\":%d}",
             temperature, humidity, soilMoisture, lightIntensity, CO2);
...
bool postToServer()
{
    ...
    snprintf(jsonBuf, sizeof(jsonBuf),
             "{\"device_id\":\"esp32_01\",\"temperature\":%u,\"humidity\":%u,\"soil_moisture\":%u,\"LightLux\":%u,\"CO2Value\":%u}",
             temperature, humidity, soilMoisture, lightIntensity, CO2);
